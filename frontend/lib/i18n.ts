...
const dictionaries: Dictionaries = {
  en: {
    ...
    "demo.speaker1": "Alex Kim",
    "demo.speaker2": "Mina Lee",
    "demo.speaker3": "Jae Park",
    "demo.topicDrift": "Hold on, we're off the agenda. Let's return to the sprint plan. Lunch ideas go to the parking lot.",
    "demo.parkingLot": "Lunch ideas",
    "demo.principleViolation": "Pause! That violates our shared decision-making principle. Do we agree?",
    "demo.violatedPrinciple": "Shared decision-making",
    "demo.participation": "Quick check-in: Jieun hasn't spoken yet. How do you see it from a design lens?",
    "demo.speakerSuggest": "Jieun",
    "demo.lines.1": "We completed eight tasks last sprint.",
    "demo.lines.2": "Great progress. The login improvements really helped.",
    "demo.lines.3": "Next sprint, let's improve the onboarding flow.",
    "demo.lines.4": "By the way, what should we eat for lunch? That new ramen place sounds good.",
    "demo.lines.5": "Right, back to the sprint plan.",
    "demo.lines.6": "This sprint we should focus on API optimization.",
    "demo.lines.7": "I'm deciding this—please proceed as I said.",
    "demo.lines.8": "Got it.",
    "demo.lines.9": "Great. Please summarize your tasks by next week.",
  ...
  ko: {
    ...
    "demo.speaker2": "이민수",
    "demo.speaker3": "박영희",
    "demo.topicDrift": "잠깐요, 아젠다에서 벗어났어요. '스프린트 계획'으로 돌아갈게요. 점심 메뉴는 Parking Lot에 추가했습니다.",
    "demo.parkingLot": "점심 메뉴",
    "demo.principleViolation": "멈춰주세요! '수평적 의사결정' 원칙 위반입니다. 혼자 결정하시면 안 돼요. 다른 분들 동의하시나요?",
    "demo.violatedPrinciple": "수평적 의사결정",
    "demo.participation": "잠깐요! 최지은 님 아직 한 번도 발언 안 하셨어요. 디자인 관점에서 어떻게 보세요?",
    "demo.speakerSuggest": "최지은",
    "demo.lines.1": "지난 스프린트에서 8개 태스크를 완료했습니다.",
    "demo.lines.2": "네, 성과가 좋았어요. 특히 로그인 개선이 효과적이었습니다.",
    "demo.lines.3": "다음 스프린트에서는 온보딩 플로우를 개선하려고 합니다.",
    "demo.lines.4": "그런데 점심 뭐 먹을까요? 회사 앞에 새로 생긴 라멘집이 맛있다던데.",
    "demo.lines.5": "아, 네. 다음 스프린트 계획을 보면...",
    "demo.lines.6": "이번 스프린트는 API 최적화에 집중합시다.",
    "demo.lines.7": "이건 제가 결정했으니까, 다들 이대로 진행해 주세요.",
    "demo.lines.8": "네, 알겠습니다.",
    "demo.lines.9": "좋습니다. 그럼 다음 주까지 각자 태스크 정리해주세요.",
